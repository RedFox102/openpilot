...
def apply_driver_steer_torque_limits(apply_torque, apply_torque_last, driver_torque, LIMITS, steer_max=None):
  # some cars use a dynamic (e.g. speed-dependent) max steer instead of a fixed LIMITS.STEER_MAX
